...
class Solution {
    ...
    public int findingSmallestPositiveInteger(int[] givenArray) {
        ...
        return smallestPositiveIntege;
    }
    
    public List<Integer> separatingPositiveAnNegativeNumbers(int[] givenArray){
    ...
    public int findingSmallestPositiveIntegerWhenStartsWithOne(List <Integer> positiveNumbers){         
